...
class Usuario extends CI_Controller
{
	...
	public function seguir_deixardeseguir()
    {
    	$id_seguidor = $this->input->post('id_seguidor');
		$id_seguido = $this->input->post('id_seguido');
    	$dados = array('id_seguidor'=>$id_seguidor,
					   'id_seguido'=>$id_seguido,
					   'data'=>date('Y-m-d'),
					   'hora'=>date('H:i:s'));
		if($this->usuario->get_seguir_by_seguidor_seguido($id_seguidor,$id_seguido)==null){
			if($this->usuario->seguir($dados)){
				echo json_encode('seguir');	
			}
		}else{
			if($this->usuario->deixar_seguir($dados)){
				echo json_encode('deixar_seguir');	
			}
		}
